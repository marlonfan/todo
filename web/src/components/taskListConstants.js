...
export const TASK_SPLIT_MIN_TOTAL_WIDTH = TASK_SPLIT_MIN_LIST_WIDTH + TASK_SPLIT_DIVIDER_WIDTH + TASK_SPLIT_MIN_DETAIL_WIDTH;
export const TASK_DETAIL_SPLIT_MIN_WIDTH = Math.max(800, TASK_SPLIT_MIN_TOTAL_WIDTH + 24);
