...
import { $ as n, b as r, et as i, f as a, k as o, nt as s, x as c, z as l } from "./chunk-CSCIHK7Q-Bm1gw87X.mjs";
import "./chunk-5ZQYHXKU-cRTMH84-.mjs";
import "./chunk-O5CBEL6O-CALp6o7A.mjs";
import "./chunk-BSJP7CBP-DER-ilWr.mjs";
import "./chunk-L5ZTLDWV-KdfSpm4k.mjs";
import { t as u } from "./chunk-55IACEB6-BzWRYPzr.mjs";
import { t as d } from "./chunk-2J33WTMH-BVQPZaMK.mjs";
import "./chunk-NZK2D7GU-CsuOrk0Z.mjs";
import "./chunk-3OPIFGDE-14tG0H5Y.mjs";
import "./chunk-KSCS5N6A-BZYd77D3.mjs";
import { r as f, t as p } from "./chunk-LZXEDZCA-D7o8lyms.mjs";
...
function b(e, t, n) {
	...
	e = e || {};
	let o = (r = (i = e.random) == null ? (a = e.rng) == null ? void 0 : a.call(e) : i) == null ? v() : r;
...
var C = S, w = 12, T = {
	...
	flattenNodes(e, n) {
		...
		let o = a.join(" "), s = /* @__PURE__ */ t((e) => {
			...
			switch (e) {
				case T.CIRCLE: return "mindmapCircle";
				case T.RECT: return "rect";
				case T.ROUNDED_RECT: return "rounded";
				case T.CLOUD: return "cloud";
				case T.BANG: return "bang";
				case T.HEXAGON: return "hexagon";
				case T.DEFAULT: return r ? "rounded" : "defaultMindmapNode";
				case T.NO_BORDER:
				default: return "rect";
			}
		}, "getShapeFromType"), l = {
...
}, t(x, "MindmapDB"), x), D = { draw: /* @__PURE__ */ t(async (t, n, i, o) => {
	var s, c, l, m;
	...
	return a;
}, "genSections"), k = /* @__PURE__ */ t((e, t, n) => {
	let r = "";
	for (let i = 0; i < e; i++) r += `
