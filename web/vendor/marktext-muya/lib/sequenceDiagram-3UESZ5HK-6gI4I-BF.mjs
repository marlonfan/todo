...
import { A as r, F as i, G as a, H as o, K as s, O as c, U as l, a as u, b as d, c as f, i as p, r as m, s as h, v as g, w as _, x as v, y, z as b } from "./chunk-CSCIHK7Q-Bm1gw87X.mjs";
import { g as x, p as S } from "./chunk-5ZQYHXKU-cRTMH84-.mjs";
import { a as C, c as w, i as T, n as E, r as D, s as O } from "./chunk-ND2GUHAM-DU3M-HUf.mjs";
import { t as k } from "./chunk-QZHKN3VN-DByBNTKB.mjs";
import { n as A, t as j } from "./chunk-XPW4576I-Kzrr1HOt.mjs";
import { t as M } from "./mermaid.core-ClIT2jZ-.mjs";
//#region ../../node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.core/sequenceDiagram-3UESZ5HK.mjs
var N = M(), P, F = (function() {
...
`;
	...
	if (U.has(p) && (x.style("stroke", g[S % g.length]), x.style("fill", h[S % g.length])), f === "neo" && x.attr("filter", "url(#drop-shadow)"), t.rectData = y, (c = t.properties) != null && c.icon) {
		...
		e.charAt(0) === "@" ? D(v, y.x + y.width - 20, y.y + 10, e.substr(1)) : T(v, y.x + y.width - 20, y.y + 10, e);
	}
	...
	if (S.node) {
		...
		t.height = e.height, E = e.height;
	}
	return i || (v.attr("data-et", "participant"), v.attr("data-type", "collections"), v.attr("data-id", t.name)), E;
	...
	let x = y.height / 2, S = x / (2.5 + y.height / 50), C = v.append("g"), w = v.append("g"), E = `M ${y.x},${y.y + x}
    a ${S},${x} 0 0 0 0,${y.height}
    h ${y.width - 2 * S}
    a ${S},${x} 0 0 0 0,-${y.height}
    Z
  `;
	C.append("path").attr("d", E), w.append("path").attr("d", `M ${y.x},${y.y + x}
	...
	let k = (s = a.get(t.name)) == null ? 0 : s;
	if (U.has(p) && (C.style("stroke", g[k % g.length]), C.style("fill", h[k % g.length]), w.style("stroke", g[k % g.length]), w.style("fill", h[k % g.length])), (c = t.properties) != null && c.icon) {
		let e = t.properties.icon.trim(), n = y.x + y.width - 20, r = y.y + 10;
		e.charAt(0) === "@" ? D(v, n, r, e.substr(1)) : T(v, n, r, e);
	}
...
`;
	...
	let k = T.select("path:last-child");
	if (k.node()) {
		var A;
		t.height = k.node().getBBox().height + ((A = n.sequence.labelBoxHeight) == null ? 0 : A);
	}
	...
	var s;
	let { theme: c, themeVariables: l } = r, { bkgColorArray: u, borderColorArray: d, mainBkg: f } = l, p = O(), m = t.anchored, h = t.actor;
	...
	let c = i.db.getActors(), l = c.get(n.from), u = c.get(n.to), d = r.sequenceVisible, f = l.x + l.width / 2, p = u.x + u.width / 2, m = f <= p, h = nt(n, i), g = e.append("g"), _ = 16.5, v = /* @__PURE__ */ t((e, t) => {
		let n = e ? _ : -_;
		return t ? -n : n;
...
var ze = /* @__PURE__ */ t(async function(e, t, n, i, a, o) {
	let { startx: s, stopx: l, starty: u, message: d, type: f, sequenceIndex: p, sequenceVisible: m } = t, g = x.calculateTextDimensions(d, Q(X)), _ = w();
